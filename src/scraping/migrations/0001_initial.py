# Generated by Django 3.0.7 on 2020-06-06 00:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=70, unique=True, verbose_name='Название населенного пункта')),
                ('slug', models.CharField(blank=True, max_length=70, unique=True)),
            ],
            options={
