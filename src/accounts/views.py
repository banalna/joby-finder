...
def update_view(request):
    ...
    if request.user.is_authenticated:
        ...
        form = UserUpdateForm(initial={'city': user.city, 'programming_language': user.programming_language,
    ...
    if request.method == 'POST':
        ...
        if contact_form.is_valid():
            ...
            if qs.exists():
                ...
                data.append({'city': city, 'email': email, 'programming_language': language})
                err.data['user_data'] = data
                err.save()
            else:
                data = {'user_data':[{'city': city, 'email': email, 'programming_language': language}]}
